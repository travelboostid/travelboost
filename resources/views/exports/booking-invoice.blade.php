        ...
        <div class="page">
                ...
                <div class="brand">
                    <div class="brand-row">
                        <div class="logo-box">
                            ...
                            @else
                                <span class="logo-initial">{{ strtoupper(substr($agentName, 0, 1)) }}</span>
                            @endif
                        </div>
                ...
                <div class="panel-body">
                    ...
                    <div class="tour-meta">
                        <div class="tour-meta-item">
                            ...
                            <span class="meta-value">{{ $tour?->code ?? '-' }}</span>
                        </div>
                        <div class="tour-meta-item">
                            <span class="meta-caption">Departure Date</span>
                            <span class="meta-value">{{ $formatDate($booking->departure_date) }}</span>
                        </div>
                        <div class="tour-meta-item">
                            <span class="meta-caption">Return Date</span>
                            <span class="meta-value">{{ $formatDate($returnDate) }}</span>
                        </div>
                        <div class="tour-meta-item">
                    ...
                    <table class="pax-grid">
                        @foreach (collect($priceBreakdown)->chunk(2) as $row)
                            <tr>
                                @foreach ($row as $item)
                                    <td>{{ $item['category'] }}</td>
                                    <td class="pax-count">{{ $item['pax'] }} pax</td>
                                @endforeach
                                @if ($row->count() === 1)
                                    <td></td>
                                    <td></td>
                ...
                <tbody>
                    @foreach ($paymentDetails as $item)
                        <tr>
                            ...
                            <td class="amount">{{ $item['discount'] > 0 ? $formatCurrency($item['discount']) : '-' }}</td>
                            <td class="amount strong">{{ $formatCurrency($item['amount']) }}</td>
                        </tr>
                    @endforeach
                    <tr class="table-total">
                        <td colspan="4">Payment Details Total</td>
                        <td class="amount">{{ $formatCurrency($paymentDetailsTotal) }}</td>
                    </tr>
                </tbody>
            </table>
            ...
            <div class="summary-grid">
                <div class="summary-left">
                    <table class="summary-table">
                        ...
                        <tr>
                            <td>Other Charges</td>
                            <td class="amount">{{ $formatCurrency($otherChargeAmount) }}</td>
                        </tr>
                        <tr class="discount">
                            <td>Discount</td>
                            <td class="amount">{{ $discountAmount > 0 ? '-'.$formatCurrency($discountAmount) : $formatCurrency(0) }}</td>
                        </tr>
                        <tr class="total">
                            <td>Grand Total</td>
                ...
                <div class="summary-right">
                    <div class="grand-box">
                        ...
                        <div class="grand-amount">{{ $formatCurrency($grandTotal) }}</div>
                    </div>
                </div>
            </div>
            ...
            <div class="paid-stamp">
                ...
                <div class="paid-right">
                    ...
                    <div class="payment-total">{{ $formatCurrency($paidAmount) }}</div>
                </div>
            </div>
