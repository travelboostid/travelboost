...
/**
 * @summary List chat rooms for a member using cursor pagination
 */
...
export const getGetChatRoomsQueryOptions = <
    ...
    TError = AuthorizationExceptionResponse | ValidationExceptionResponse,
>(
    params?: GetChatRoomsParams,
    options?: {
        query?: Partial<
...
export type GetChatRoomsQueryResult = NonNullable<
    Awaited<ReturnType<typeof getChatRooms>>
>;
export type GetChatRoomsQueryError =
    | AuthorizationExceptionResponse
    | ValidationExceptionResponse;
...
/**
 * @summary Open or reuse a private chat room between two members
 */
