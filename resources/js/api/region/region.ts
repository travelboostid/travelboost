...
export const getRegions = (
    ...
    return apiInstance<GetRegions200>(
        { url: `/regions`, method: 'GET', params, signal },
        options,
    );
};
...
>(
    ...
    const queryFn: QueryFunction<Awaited<ReturnType<typeof getRegions>>> = ({
        signal,
    }) => getRegions(params, requestOptions, signal);
...
export type GetRegionsQueryResult = NonNullable<
    Awaited<ReturnType<typeof getRegions>>
>;
export type GetRegionsQueryError =
    | AuthenticationExceptionResponse
    | ValidationExceptionResponse;
...
export type CreateRegionMutationError =
    | AuthenticationExceptionResponse
    | ValidationExceptionResponse;
...
>(
    ...
    const queryFn: QueryFunction<Awaited<ReturnType<typeof getRegionById>>> = ({
        signal,
    }) => getRegionById(id, requestOptions, signal);
...
export type UpdateRegionMutationError =
    | AuthenticationExceptionResponse
    | ValidationExceptionResponse;
