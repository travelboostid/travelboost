...
export const getVendors = (
    ...
    return apiInstance<GetVendors200>(
        { url: `/vendors`, method: 'GET', params, signal },
        options,
    );
};

export const getGetVendorsQueryKey = (params?: GetVendorsParams) => {
    return [`/vendors`, ...(params ? [params] : [])] as const;
};
...
>(
    ...
    const queryFn: QueryFunction<Awaited<ReturnType<typeof getVendors>>> = ({
        signal,
    }) => getVendors(params, requestOptions, signal);
...
export type GetVendorsQueryResult = NonNullable<
    Awaited<ReturnType<typeof getVendors>>
>;
export type GetVendorsQueryError =
    | AuthenticationExceptionResponse
    | ValidationExceptionResponse;
...
export function useGetVendors<
    ...
    TError = AuthenticationExceptionResponse | ValidationExceptionResponse,
>(
    params: undefined | GetVendorsParams,
    options: {
        query: Partial<
            UseQueryOptions<
                Awaited<ReturnType<typeof getVendors>>,
