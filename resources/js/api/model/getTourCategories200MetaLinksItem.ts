 ...
 */
import type { GetTourCategories200MetaLinksItemUrl } from './getTourCategories200MetaLinksItemUrl';

export type GetTourCategories200MetaLinksItem = {
    url: GetTourCategories200MetaLinksItemUrl;
    label: string;
    active: boolean;
};
