...
export const getCountries = (
    ...
    return apiInstance<GetCountries200>(
        { url: `/countries`, method: 'GET', params, signal },
        options,
    );
};
...
export type GetCountriesQueryResult = NonNullable<
    Awaited<ReturnType<typeof getCountries>>
>;
export type GetCountriesQueryError =
    | AuthenticationExceptionResponse
    | ValidationExceptionResponse;
...
export type CreateCountryMutationError =
    | AuthenticationExceptionResponse
    | ValidationExceptionResponse;
...
>(
    ...
    const queryFn: QueryFunction<
        Awaited<ReturnType<typeof getCountryById>>
    > = ({ signal }) => getCountryById(id, requestOptions, signal);
...
export type UpdateCountryMutationError =
    | AuthenticationExceptionResponse
    | ValidationExceptionResponse;
