...
/**
 * @summary List withdrawals for the authenticated user
 */
export const getWithdrawals = (
    ...
    return apiInstance<GetWithdrawals200>(
        { url: `/withdrawals`, method: 'GET', params, signal },
        options,
    );
};

export const getGetWithdrawalsQueryKey = (params?: GetWithdrawalsParams) => {
    return [`/withdrawals`, ...(params ? [params] : [])] as const;
};
...
>(
    ...
    const queryKey =
        queryOptions?.queryKey ?? getGetWithdrawalsQueryKey(params);

    const queryFn: QueryFunction<
        Awaited<ReturnType<typeof getWithdrawals>>
    > = ({ signal }) => getWithdrawals(params, requestOptions, signal);
...
export type GetWithdrawalsQueryResult = NonNullable<
    Awaited<ReturnType<typeof getWithdrawals>>
>;
export type GetWithdrawalsQueryError =
    | AuthenticationExceptionResponse
    | ValidationExceptionResponse;
...
export function useGetWithdrawals<
    ...
    TError = AuthenticationExceptionResponse | ValidationExceptionResponse,
>(
    params: undefined | GetWithdrawalsParams,
    options: {
        query: Partial<
            UseQueryOptions<
                Awaited<ReturnType<typeof getWithdrawals>>,
