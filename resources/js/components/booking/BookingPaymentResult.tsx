...
function getResultCopy(result: BookingPaymentResultData) {
  ...
  if (
    ...
    return {
      ...
      body: 'We have received your transfer proof. We will verify it and update your booking status after approval.',
              ...
              <div className="space-y-3">
                <p
                  className={cn(
                    ...
                    copy.tone === 'neutral' && 'text-primary',
                  )}
                >
                  {copy.eyebrow}
                </p>
            ...
            <div className="overflow-hidden rounded-2xl border bg-card shadow-xl shadow-foreground/5">
              ...
              <div className="space-y-5 p-5 sm:p-6">
                ...
                <div className="space-y-3 rounded-xl border bg-muted/20 p-4">
                  <AmountRow label="Grand Total" value={result.grandTotal} />
                  <AmountRow label="Paid Amount" value={result.paidAmount} />
                  <AmountRow
