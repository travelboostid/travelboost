...
const terms: Record<'affiliate' | 'agent', Record<TermsLanguage, TermsCopy>> = {
    affiliate: {
        en: {
            title: 'Terms and Conditions for TravelBoost Affiliate Marketing Partnership',
        ...
        id: {
            title: 'Terms and Conditions (Syarat dan Ketentuan) Kemitraan Pemasaran - Afiliator TravelBoost',
