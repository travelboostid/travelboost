            ...
            <div className="rounded-md border-2 border-dashed border-primary p-4 text-left flex flex-row gap-2 items-center">
              ...
              <div className="flex-1">
                ...
                <div className="text-sm text-muted-foreground">
                  Click remove to delete the uploaded identity card and
                  reupload, or click download to see the uploaded file.
                </div>
              </div>
              <div className="space-x-2">
                ...
                <a
                  href={(internalValue as any)?.data?.url || '#'}
                  target="_blank"
          ...
          return (
            <div className="rounded-md border-2 border-dashed p-4 text-left flex flex-row gap-2 items-center">
              ...
              <div className="flex-1">
                ...
                <div className="text-sm text-muted-foreground">
                  Please upload a clear image or scan of your identity card for
