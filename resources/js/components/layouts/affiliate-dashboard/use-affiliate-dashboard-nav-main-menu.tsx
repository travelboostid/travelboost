                    ...
                    items: [
                        {
                            ...
                            title: 'MA Approval',
                            urlOrAction:
                                '/affiliate/dashboard/network/approvals?tier=ma',
                        },
                        {
                            id: 'network_ma.list',
                            title: 'MA List',
                            urlOrAction:
                                '/affiliate/dashboard/network/list?tier=ma',
                        },
                    ],
                },
                {
                    ...
                    urlOrAction:
                        '/affiliate/dashboard/network/list?tier=affiliate',
                    icon: UsersRoundIcon,
                },
                {
                    id: 'agent_list',
        ...
        menuItems.push(
            {
                ...
                items: [
                    ...
                    },
                    {
                        ...
                        urlOrAction:
                            '/affiliate/dashboard/fund/commission-history',
                    },
                    {
                        id: 'fund.bank',
                        title: 'Bank Account',
