        ...
        <StdLayout>
            ...
            <section className="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
                <div className="mb-16 text-center">
                    ...
                    <p className="mx-auto max-w-3xl text-xl text-foreground/70">
                        Jelajahi solusi lengkap untuk mengelola, mempromosikan,
                        dan mengembangkan bisnis perjalanan Anda
                    </p>
                </div>
            </section>
                ...
                <div className="mb-20 grid items-center gap-12 md:grid-cols-2">
                    <div>
                        ...
                        <p className="mb-6 text-lg leading-relaxed text-foreground/70">
                            TravelBoost menghubungkan vendor perjalanan
                            terpercaya dengan agen yang mencari paket
                            berkualitas. Vendor dapat mendaftarkan dan mengelola
                            paket tour mereka dengan mudah.
                        </p>
                        <div className="space-y-4">
                            <div className="flex gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-foreground/70">
                                        Kelola destinasi, harga, jadwal, dan
                                        detail paket dengan dashboard intuitif
                                    </p>
                                </div>
                            </div>
                            <div className="flex gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-foreground/70">
                                        Paket Anda tampil kepada ribuan agen
                            ...
                            <div className="flex gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-foreground/70">
                                        Pantau performa paket dengan metrik
                                        terperinci dan laporan mendalam
                                    </p>
                                </div>
                            </div>
                        </div>
            ...
            <section className="mx-auto max-w-7xl border-t border-border px-4 py-20 sm:px-6 lg:px-8">
                <div className="grid items-center gap-12 md:grid-cols-2">
                    ...
                    <div className="order-1 md:order-2">
                        ...
                        <p className="mb-6 text-lg leading-relaxed text-foreground/70">
                            Agen perjalanan dapat dengan mudah menelusuri dan
                            memilih paket tour yang sesuai dari ribuan penawaran
                            vendor terpercaya. Sistem rekomendasi kami membantu
                            menemukan paket ideal.
                        </p>
                        <div className="space-y-4">
                            <div className="flex gap-3">
                                <div className="flex h-6 w-6 flex-shrink-0 items-center justify-center rounded-full bg-primary/20">
                                ...
                                <div>
                                    ...
                                    <p className="text-foreground/70">
                                        Cari berdasarkan destinasi, budget,
                                        durasi, dan preferensi spesifik lainnya
                                    </p>
                                </div>
                            </div>
                            <div className="flex gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-foreground/70">
                                        Negosiasikan harga khusus dan dapatkan
                                        komisi kompetitif untuk setiap booking
                                    </p>
                                </div>
                            </div>
                            <div className="flex gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-foreground/70">
                                        Monitor status booking dari pemesanan
                                        hingga pelaksanaan perjalanan
                                    </p>
                                </div>
                            </div>
                        </div>
            ...
            <section className="mx-auto max-w-7xl border-t border-border px-4 py-20 sm:px-6 lg:px-8">
                <div className="mb-12 text-center">
                    ...
                    <p className="text-xl text-foreground/70">
                        Sistem otomatis yang mengelola kapasitas penumpang dan
                        ketersediaan paket secara real-time
                    </p>
                </div>
            ...
            <section className="mx-auto max-w-7xl border-t border-border px-4 py-20 sm:px-6 lg:px-8">
                <div className="grid items-center gap-12 md:grid-cols-2">
                    <div>
                        ...
                        <p className="mb-6 text-lg leading-relaxed text-foreground/70">
                            Setiap agen mendapat landing page profesional yang
                            dapat dikustomisasi sepenuhnya. Tampilkan brand Anda
                            dengan gaya unik tanpa perlu keahlian teknis.
                        </p>
                        <div className="mb-8 space-y-4">
                            <div className="flex gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-foreground/70">
                                        Buat landing page tanpa coding. Editor
                                        visual yang mudah digunakan dengan
                                        berbagai template siap pakai
                                    </p>
                                </div>
                            </div>
                            <div className="flex gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-foreground/70">
                                        Unggah logo, warna brand, foto, dan
                                        konten sendiri untuk menciptakan
                                        identitas unik
                                    </p>
                                </div>
                            </div>
                            <div className="flex gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-foreground/70">
                                        Gunakan domain pribadi Anda atau domain
                                        TravelBoost dengan subdomain unik
                                    </p>
                                </div>
                            </div>
                            <div className="flex gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-foreground/70">
                                        Tools SEO bawaan untuk membantu landing
                                        page Anda tampil di pencarian Google
                                    </p>
                                </div>
                            </div>
                        </div>
            ...
            <section className="mx-auto max-w-7xl border-t border-border px-4 py-20 sm:px-6 lg:px-8">
                <div className="mb-12 text-center">
                    ...
                    <p className="text-xl text-foreground/70">
                        Semua yang Anda butuhkan untuk menjalankan bisnis
                    ...
                    <div className="grid items-center gap-12 md:grid-cols-2">
                        <div>
                            ...
                            <p className="mb-8 text-lg text-foreground/70">
                                Bergabunglah dengan ribuan agen perjalanan yang
                                telah mempercayai TravelBoost untuk
                                mengembangkan bisnis mereka. Hubungi tim kami
                                untuk demo gratis dan konsultasi bisnis.
                            </p>
                            <Button
                                asChild
                                size="lg"
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="flex gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-foreground/70">
                                        Tingkatkan penjualan hingga 300% dalam 6
                                        bulan pertama
                                    </p>
                                </div>
                            </div>
                            <div className="flex gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-foreground/70">
                                        Tim ahli siap membantu kesuksesan Anda
                                        setiap saat
                                    </p>
                                </div>
                            </div>
