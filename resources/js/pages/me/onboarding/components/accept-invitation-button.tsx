        ...
        <AlertDialog open={open} onOpenChange={setOpen}>
            ...
            <AlertDialogContent>
                <AlertDialogHeader>
                    ...
                    <AlertDialogDescription>
                        You'll accept the invitation to join this company. If
                        you feel this invitation is not appropriate or you want
                        to create your own account instead, please decline the
                        invitation.
                    </AlertDialogDescription>
                </AlertDialogHeader>
