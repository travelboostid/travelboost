        ...
        <Item variant="outline">
            <ItemMedia>
                <Avatar className="size-10">
                    <AvatarImage
                        src={invitation.company.photo_url || DEFAULT_PHOTO}
                    />
                    <AvatarFallback>
                        {' '}
                        <UserIcon />
                ...
                <div className="flex gap-2 items-center">
                    ...
                    <div className="flex-1">
                        <div className="font-bold text-lg">
                            System detects that your email has already been
                            invited to join a company.
                        </div>
                        <div className="text-muted-foreground">
                            You can accept the invitation, or decline it. Please
                            note that a single email only can be used for
                            managing one company.
                        </div>
                    </div>
                </div>
