...
const DefaultThemePuckConfig: Config<DefaultThemePuckProps> = {
    ...
    components: {
        ...
        AboutUs: withLayoutComponentConfig(
            AboutUsComponentConfig as any,
        ) as any,
        ...
        Features: withLayoutComponentConfig(
            FeaturesComponentConfig as any,
        ) as any,
        ...
        Footer1: withLayoutComponentConfig(
            Footer1ComponentConfig as any,
        ) as any,
