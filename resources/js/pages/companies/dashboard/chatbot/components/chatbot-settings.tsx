                    ...
                    <FieldLabel htmlFor="chatbot_enabled">
                        <Field orientation="horizontal">
                            <FieldContent>
                                ...
                                <FieldDescription>
                                    Toggle to enable or disable the chatbot for
                                    your company. When enabled, the chatbot will
                                    be active and available to assist your
                                    customers with their inquiries and support
                                    needs.
                                </FieldDescription>
                            </FieldContent>
                            <Switch
