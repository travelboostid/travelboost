...
import ContinuePayment from './continue-ai-credit-payment';
...
export default function PendingAiCreditTopup() {
                    ...
                    <div className="flex items-start gap-3">
                        ...
                        <div className="space-y-1">
                            <CardTitle className="text-base">
                                <FormattedMessage defaultMessage="Pending AI credits top-up" />
                            </CardTitle>
                            <CardDescription className="text-sm leading-relaxed">
                                {amount !== null ? (
                                    <FormattedMessage
                                        defaultMessage="Complete your {amount} top-up to add credits to your account."
                                        values={{ amount: formatIDR(amount) }}
                                    />
                                ) : (
                                    <FormattedMessage defaultMessage="Complete your top-up to add credits to your account." />
                                )}
                            </CardDescription>
                        </div>
                    </div>
