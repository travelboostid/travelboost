            ...
            <CardContent className="space-y-6 pt-6">
                <div className="grid gap-6 sm:grid-cols-3">
                    ...
                    <div className="space-y-2">
                        ...
                        <p className="text-lg font-bold text-slate-900">
                            {dayjs(agentSubscription.ended_at).format(
                                'DD MMM YYYY',
                            )}
                        </p>
                        <p className="text-sm text-slate-500">
                            Since{' '}
                            {dayjs(agentSubscription.started_at).format(
                                'DD MMM YYYY',
                            )}
                        </p>
                    </div>
                    ...
                    <div className="space-y-2">
                        ...
                        <p className="text-sm text-slate-500">
                            Rp{' '}
                            {Number(
                                agentSubscription.package.price,
                            ).toLocaleString('id-ID')}
                            ,- / {agentSubscription.package.duration_months}{' '}
                            Months
                        </p>
                    </div>
                </div>
