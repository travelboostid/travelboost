...
export default function TeamRow({
  ...
  return (
    <TableRow className="hover:bg-muted/40">
        ...
        {hasUser ? (
          <div className="flex items-center gap-3">
            ...
            <div className="min-w-0">
              ...
              <div className="text-sm text-muted-foreground">Team account</div>
            </div>
          </div>
        ) : (
          <div className="space-y-1">
            <div className="font-medium text-foreground">Legacy Invitation</div>
      ...
      <TableCell className="px-4 py-4">
        <TeamStatusSelect team={team} canManageMembers={canManageMembers} />
      </TableCell>
