    ...
    post(window.location.pathname, {
      data: {
        ...
        minimum_down_payment:
          parseFloat(String(data.minimum_down_payment).replace(',', '.')) || 0,
            ...
            <div className="grid grid-cols-1 gap-4 lg:grid-cols-2">
              <div>
                ...
                <MoneyInput
                  ...
                  onChange={(raw) => setData('booking_deadline', Number(raw))}
                />
              ...
              <div>
                ...
                <MoneyInput
                  ...
                  className={inputClass}
                  onChange={(raw) =>
                    setData('booking_entry_time_limit', Number(raw))
                  }
                />
            ...
            <div className="grid grid-cols-1 gap-4 lg:grid-cols-2">
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setData('manual_bank_transfer', e.target.value)
                  }
                />
              </div>
              ...
              <div>
                ...
                <input
                  type="text"
                  className={inputClass}
                  value={data.manual_bank_transfer_account_name}
                  onChange={(e) =>
                    setData('manual_bank_transfer_account_name', e.target.value)
                  }
                />
              </div>
              ...
              <div className="md:col-span-2">
                ...
                <input
                  type="text"
                  className={inputClass}
                  value={data.manual_bank_transfer_account_number}
                  onChange={(e) =>
                    setData(
                      'manual_bank_transfer_account_number',
                      e.target.value,
