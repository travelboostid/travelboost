    ...
    () => [
      {
        ...
        header: ({ column }) => (
          <DataTableColumnHeader column={column} label="Vendor Partner" />
        ),
        cell: ({ row }) => {
      ...
      },
      {
        ...
        cell: ({ row }) => <ShowVendorToggle registration={row.original} />,
        enableSorting: false,
      },
      {
        id: 'status',
      ...
      },
      {
        ...
        header: ({ column }) => (
          <DataTableColumnHeader column={column} label="Applied Date" />
        ),
        cell: ({ cell }) => {
          const appliedAt = cell.getValue<string>();
          if (!appliedAt) return <span className="text-slate-400">-</span>;
          return (
          ...
          return (
            <TooltipProvider>
              <Tooltip>
                ...
                <TooltipContent>
                  {isActive ? 'Managed by Vendor' : 'Cancel Registration'}
                </TooltipContent>
              </Tooltip>
            </TooltipProvider>
          );
