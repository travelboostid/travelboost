                    ...
                    <>
                        <Alert className="flex items-center gap-4">
                            <Avatar className="h-12 w-12 rounded-lg">
                                <AvatarImage
                                    src={
                                        team.company.photo_url || DEFAULT_PHOTO
                                    }
                            ...
                            <div className="flex-1 flex-col justify-center gap-2">
                                <AlertTitle className="flex-1">
                                    <strong>{team.company.name}</strong> is
                                    inviting you to join.
                                </AlertTitle>
                                <AlertDescription className="text-xs">
                                    If you are not intended to join, you can
                                    safely ignore this invitation.
                                </AlertDescription>
                            </div>
                        </Alert>
                        <input
