            ...
            <section className="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
                <div className="mb-20 text-center">
                    ...
                    <p className="mx-auto max-w-3xl text-xl text-foreground/70">
                        Kami adalah mitra terpercaya yang berkomitmen untuk
                        membantu agen perjalanan berkembang dan mencapai
                        kesuksesan mereka.
                    </p>
                </div>
                ...
                <div className="mb-20 grid items-center gap-12 md:grid-cols-2">
                    ...
                    <div>
                        ...
                        <p className="mb-4 text-lg leading-relaxed text-foreground/70">
                            TravelBoost didirikan dengan visi untuk merevolusi
                            cara agen perjalanan mempromosikan layanan mereka.
                            Kami memahami tantangan yang dihadapi industri
                            perjalanan di Indonesia dan berkomitmen untuk
                            memberikan solusi yang inovatif dan terpercaya.
                        </p>
                        <p className="text-lg leading-relaxed text-foreground/70">
                            Melalui platform kami, ribuan agen perjalanan telah
                            meningkatkan jangkauan pasar mereka dan mencapai
                ...
                <div className="mb-20 grid gap-8 md:grid-cols-2">
                    <div className="rounded-lg border border-border bg-card p-8">
                        ...
                        <p className="leading-relaxed text-foreground/70">
                            Memberdayakan agen perjalanan Indonesia dengan
                            teknologi modern dan solusi pemasaran yang efektif,
                            sehingga mereka dapat fokus pada pertumbuhan bisnis
                    ...
                    <div className="rounded-lg border border-border bg-card p-8">
                        ...
                        <p className="leading-relaxed text-foreground/70">
                            Menjadi platform terdepan di Asia Tenggara untuk
                            promosi dan manajemen agen perjalanan, menciptakan
                            ekosistem bisnis yang berkelanjutan dan
                            menguntungkan.
                        </p>
                    </div>
                </div>
            ...
            <section className="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
                <div className="rounded-2xl border border-primary/20 bg-gradient-to-r from-primary/10 to-accent/10 p-12 text-center">
                    ...
                    <p className="mb-8 text-lg text-foreground/70">
                        Hubungi tim kami hari ini untuk mengetahui bagaimana
                        TravelBoost dapat membantu mengembangkan bisnis Anda.
                    </p>
                    <Button
                        asChild
                        size="lg"
