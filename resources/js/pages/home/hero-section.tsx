            ...
            <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-10 pb-20">
                <div className="max-w-3xl">
                    <h1 className="text-4xl md:text-5xl lg:text-6xl font-georgia font-bold text-card leading-tight">
                        Selamat Datang di TravelBoost: Platform Promosi Agen
                        Perjalanan Terbaik Anda
                    </h1>

                    <p className="mt-6 text-lg md:text-xl text-card/90 leading-relaxed">
                        Buka kemungkinan baru untuk bisnis perjalanan Anda.
                        TravelBoost memberdayakan agen perjalanan dengan alat
                        canggih untuk sukses.
                    </p>
