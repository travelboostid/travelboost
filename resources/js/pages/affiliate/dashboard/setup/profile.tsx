            ...
            <div className="max-w-4xl mx-auto space-y-6">
                <div>
                    ...
                    <p className="text-muted-foreground">
                        Complete your profile to expedite the verification
                        process.
                    </p>
                </div>
                ...
                <form onSubmit={submit} className="space-y-6">
                    <Card className="border-border shadow-sm">
                        <CardHeader>
                            ...
                            <CardDescription>
                                Your basic login credentials and landing page
                                link.
                            </CardDescription>
                        </CardHeader>
                        <CardContent>
                            <div className="flex flex-col md:flex-row gap-8 items-start">
                                <div className="flex flex-col items-center gap-4 shrink-0 mx-auto md:mx-0">
                                    ...
                                    <InputError
                                        message={errors.photo_id as string}
                                    />
                                </div>
                    ...
                    <Card className="border-border shadow-sm border-l-4 border-l-primary/20">
                        <CardHeader className="bg-primary/5 border-b">
                            ...
                            <CardDescription>
                                Please provide valid identity information for
                                verification and commission payouts.
                            </CardDescription>
                        </CardHeader>
                                ...
                                <div className="space-y-4">
                                    <div className="space-y-2">
                                        ...
                                        {data.identity_number.length > 0 &&
                                            data.identity_number.length <
                                                16 && (
                                                <p className="text-[0.8rem] font-medium text-destructive">
                                                    ID Number must be exactly 16
                                                    digits.
                                                </p>
                                            )}
                                        <InputError
                                    ...
                                    <div className="p-4 rounded-xl border-2 border-dashed bg-muted/10 flex flex-col gap-3">
                                        ...
                                        <InputError
                                            message={
                                                errors.identity_card_id as string
                                            }
                                        />
                                    </div>
                                </div>
