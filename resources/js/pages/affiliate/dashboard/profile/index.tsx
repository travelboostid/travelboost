...
export default function ProfileIndex({ user }: { user: any }) {
    ...
    const submit: FormEventHandler = (e) => {
        ...
        patch('/affiliate/dashboard/profile', {
            ...
            onError: () =>
                toast.error(
                    'Gagal memperbarui profil. Silakan periksa isian Anda.',
                ),
        });
    };
        ...
        <AffiliateDashboardLayout
            breadcrumb={[
                ...
                { title: 'Pengaturan', url: '#' },
                {
                    ...
                    url: '/affiliate/dashboard/profile',
                },
            ]}
        >
            ...
            <div className="max-w-4xl space-y-6">
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>
                            Perbarui informasi dasar akun Anda. Email dan
                            Username tidak dapat diubah karena terikat dengan
                            sistem subdomain.
                        </CardDescription>
                    </CardHeader>
                    <CardContent>
