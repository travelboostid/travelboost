                        ...
                        <Card className="w-full max-w-xl rounded-3xl border-none bg-white/95 py-0 shadow-2xl ring-1 ring-slate-200 dark:bg-slate-900/95 dark:ring-slate-800">
                            <CardContent className="p-8 text-center">
                                ...
                                <p className="mt-3 text-sm leading-6 text-slate-500 dark:text-slate-400">
                                    Your affiliate registration is currently
                                    being reviewed by your network leader.
                                    Dashboard access remains limited until the
                                ...
                                {isProfileIncomplete ? (
                                            ...
                                            <div className="space-y-3">
                                                <div>
                                                    ...
                                                    <p className="mt-1 text-sm text-slate-600 dark:text-slate-300">
                                                        ...
                                                        and full address so the
                                                        team can validate your
                                                        account faster.
                                                    </p>
                                                </div>
                                                <Button
                                    ...
                                    <div className="mt-8 rounded-2xl border border-slate-200 bg-slate-50 px-4 py-3 text-sm font-normal text-slate-600 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-300">
                                        Your profile is complete. Please wait
                                        while the review is finalized.
                                    </div>
                                )}
                            </CardContent>
                        </Card>
                        ...
                        <Card className="rounded-3xl border-none bg-amber-50 py-0 shadow-sm ring-1 ring-amber-200 dark:bg-amber-500/10 dark:ring-amber-500/30">
                            <CardContent className="flex flex-col gap-4 p-5 md:flex-row md:items-center md:justify-between">
                                <div className="flex items-start gap-3">
                                    ...
                                    <div>
                                        <h3 className="text-sm font-medium text-slate-900 dark:text-slate-100">
                                            Your profile still needs a few
                                            details
                                        </h3>
                                        <p className="mt-1 text-sm text-slate-600 dark:text-slate-300">
                                            Complete your phone number and
                                            address so commission and
                                            verification processes can run
                                            smoothly.
                                        </p>
                                    </div>
                                </div>
                                    ...
                                    <div className="max-w-3xl">
                                        ...
                                        <div className="mt-5">
                                            ...
                                            <p className="mt-3 flex items-center gap-2 text-sm text-slate-500 dark:text-slate-400">
                                                ...
                                                Track your network, agent
                                                activity, and commission in one
                                                place.
                                            </p>
                                            <p className="mt-4 max-w-2xl text-sm text-slate-600 dark:text-slate-300">
                                                ...
                                                monitor new registrations, and
                                                follow subscription conversion
                                                across your network.
                                            </p>
                                        </div>
                                    </div>
                            ...
                            <div className="flex flex-col gap-3 border-b border-slate-200 bg-slate-50/70 px-6 py-5 dark:border-slate-800 dark:bg-slate-950/40 sm:flex-row sm:items-center sm:justify-between">
                                <div>
                                    ...
                                    <p className="mt-1 text-sm text-slate-500 dark:text-slate-400">
                                        The newest agents added through your
                                        affiliate network.
                                    </p>
                                </div>
                                <Button
                        ...
                        <Card className="overflow-hidden rounded-3xl border-none bg-white py-0 shadow-sm ring-1 ring-slate-200 dark:bg-slate-900 dark:ring-slate-800">
                            <div className="flex flex-col gap-3 border-b border-slate-200 bg-slate-50/70 px-6 py-5 dark:border-slate-800 dark:bg-slate-950/40 sm:flex-row sm:items-center sm:justify-between">
                                <div>
                                    ...
                                    <p className="mt-1 text-sm text-slate-500 dark:text-slate-400">
                                        Subscription conversion across your
                                        affiliator network.
                                    </p>
                                </div>
                                <Button
                            ...
                            <div className="overflow-x-auto">
                                <Table>
                                    ...
                                    <TableBody>
                                        {displayedNetworkPerformance.length >
                                        0 ? (
                                            displayedNetworkPerformance.map(
                                                (network: any) => (
                                                    <TableRow
                                                    ...
                                                    >
                                                        ...
                                                        <TableCell className="py-4">
                                                            ...
                                                            <p className="mt-2 text-xs text-slate-500 dark:text-slate-400">
                                                                {network.subscribed_agents ||
                                                                    0}{' '}
                                                                subscribed of{' '}
                                                                {network.total_agents ||
                                                                    0}{' '}
                                                                total agents
                                                            </p>
                                                        </TableCell>
