...
const dict = {
    id: {
        ...
        heroTitle:
            'Raih Penghasilan Menarik dengan Program Afiliasi TravelBoost!',
        heroDesc:
        ...
        adv5Desc:
            'Agen mendaftar sebulan kemudian? Anda tetap dapat komisinya.',
    ...
    en: {
        ...
        adv5Desc:
            'Agent registers a month later? You still get the commission.',
                    ...
                    <div className="max-w-7xl mx-auto px-6">
                        ...
                        <div className="grid md:grid-cols-2 gap-10">
                            {[
                                ...
                                <div
                                    key={i}
                                    className="bg-muted/50 p-10 rounded-3xl relative"
                                >
                                    <MessageSquareQuote
