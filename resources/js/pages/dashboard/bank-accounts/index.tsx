        ...
        <Card>
          ...
          <CardContent className="text-sm text-muted-foreground space-y-2">
            <p>
              ...
              Your account is verified and ready to use for transactions.
              Approved accounts cannot be edited.
            </p>
            <p>
              <span className="font-semibold text-foreground">Pending:</span>{' '}
              Your account is awaiting verification. You can edit details until
              it's approved.
            </p>
            <p>
              <span className="font-semibold text-foreground">Rejected:</span>{' '}
              Your account failed verification. You can edit and resubmit, or
              remove it.
            </p>
          </CardContent>
        </Card>
