...
export default function TourEditDialog({ children, tour }: any) {
  const [open, setOpen] = useState(false);
  const src =
    tour?.image?.data?.files?.find((f: any) => f.code === 'small')?.url || '';
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="max-h-screen overflow-y-scroll">
        <Form
          id="update-form"
          method="put"
          action={`/dashboard/tours/${tour.id}`}
                ...
                <DialogDescription>
                  <div className="grid gap-6">
                    ...
                    <div className="grid gap-2">
                      ...
                      <MediaPicker defaultValue={src} type="image">
                        {(media, change) => (
                          <div className="flex flex-col items-center justify-items-center gap-2">
                            <img
                              className="max-w-[360px] rounded shadow"
                              src={
                                typeof media === 'string'
                                  ? media
                    ...
                    <div className="grid gap-2">
                      ...
                      <Input
                        id="code"
                        disabled={tour.parent_id ? true : false}
                        type="text"
                        name="code"
                        required
