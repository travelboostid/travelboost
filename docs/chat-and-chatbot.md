...
This document describes how live chat and the AI chatbot auto-reply work in Travelboost, what is required to run them locally, and how to troubleshoot common failures.
...
- [Development Environment Setup](./development-environment-setup.md) — PHP extensions and local dev commands
- [App Server Setup](./app-server-setup.md) — production PHP packages including `php-bcmath`
- [Debugging Setup Guide](./debugging.md) — Xdebug for stepping through listeners and agents
- [Requirements](./requirements.md) — product context for chat and anonymous users
