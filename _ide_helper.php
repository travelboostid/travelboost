...
namespace Laravolt\Indonesia {
    ...
    class Facade {
        ...
        {
            /** @var \Laravolt\Indonesia\IndonesiaService $instance */
            return $instance->setCacheTtl($ttl);
        }
         ...
         * @static
         */
        public static function clearCacheFor($method, $params = [])
        {
            /** @var \Laravolt\Indonesia\IndonesiaService $instance */
            return $instance->clearCacheFor($method, $params);
        }

        /**
         * @static
         */
        public static function getCached($method, $params = [])
        {
            /** @var \Laravolt\Indonesia\IndonesiaService $instance */
            return $instance->getCached($method, $params);
        }

        /**
         * @static
         */
        public static function isCached($method, $params = [])
        {
            /** @var \Laravolt\Indonesia\IndonesiaService $instance */
            return $instance->isCached($method, $params);
        }
