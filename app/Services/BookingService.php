...
{
  /**
   * Create a new booking with passengers and addons within a transaction.
   *
   *
   * @throws \Exception
   */
  public function createBooking(array $data, User $user): Booking
  {
    ...
    return DB::transaction(function () use ($data, $user) {
      ...
      $randomSuffix = substr(str_shuffle(str_repeat($pool, 4)), 0, 4);
      $bookingNumber = "BKG-{$datePrefix}-{$randomSuffix}";
