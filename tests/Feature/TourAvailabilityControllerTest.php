...
test('availability save stores manual reserved times in utc based on the submitted timezone', function () {
    ...
    expect((int) $availability->RS)->toBe(2)
        ->and((int) $availability->available)->toBe(22)
        ->and((int) $availability->manual_reserved_original_available)->toBe(24)
